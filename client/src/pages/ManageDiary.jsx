...
const ManageDiary = () => {
  ...
  const acquireDiaries = (e) => {
    ...
    Axios({
      ...
      url: SERVER_URL+"find/"+findBy+"?from="+seachingConditionInfo.from+"&to="+seachingConditionInfo.to
    ...
    return (
      <div>
        ...
        <div>
          ...
          <button name="byDate" onClick={acquireDiaries}>Search</button>
        </div>
        ...
        <div>
          ...
          <button name="byScore" onClick={acquireDiaries}>Search</button>
        </div>
